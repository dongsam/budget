...
// Message types for the tax module
const (
...
func NewMsgCreateFixedAmountPlan(
	...
	return &MsgCreateFixedAmountPlan{
		TaxPoolAddress: taxPoolAddr.String(),
...
func (msg MsgCreateFixedAmountPlan) ValidateBasic() error {
	if _, err := sdk.AccAddressFromBech32(msg.TaxPoolAddress); err != nil {
		return sdkerrors.Wrapf(sdkerrors.ErrInvalidAddress, "invalid tax pool address %q: %v", msg.TaxPoolAddress, err)
	}
...
func (msg MsgCreateFixedAmountPlan) GetSigners() []sdk.AccAddress {
	addr, err := sdk.AccAddressFromBech32(msg.TaxPoolAddress)
	if err != nil {
		panic(err)
	}
