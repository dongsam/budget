...
// CreateFixedAmountPlan defines a method for creating fixed amount tax plan.
func (k msgServer) CreateFixedAmountPlan(goCtx context.Context, msg *types.MsgCreateFixedAmountPlan) (*types.MsgCreateFixedAmountPlanResponse, error) {
	...
	ctx.EventManager().EmitEvents(sdk.Events{
		sdk.NewEvent(
			...
			sdk.NewAttribute(types.AttributeKeyTaxPoolAddress, msg.TaxPoolAddress),
...
// CreateRatioPlan defines a method for creating ratio tax plan.
...
// Stake defines a method for staking coins to the tax plan.
...
// Unstake defines a method for unstaking coins from the tax plan.
...
// Harvest defines a method for claiming tax rewards from the tax plan.
