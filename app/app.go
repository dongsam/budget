...
func NewTaxApp(
	...
	govRouter.AddRoute(govtypes.RouterKey, govtypes.ProposalHandler).
		...
		AddRoute(taxtypes.RouterKey, tax.NewPublicPlanProposal(app.TaxKeeper))
		// todo: implementing...
	...
	app.mm = module.NewManager(
		...
		tax.NewAppModule(appCodec, app.TaxKeeper, app.AccountKeeper, app.BankKeeper, app.DistrKeeper),
		// todo: tax ordering
	)
	...
	app.mm.SetOrderBeginBlockers(
		...
		evidencetypes.ModuleName, stakingtypes.ModuleName, taxtypes.ModuleName,
		// todo: tax ordering
	)

	app.mm.SetOrderEndBlockers(
		crisistypes.ModuleName, govtypes.ModuleName,
		stakingtypes.ModuleName, taxtypes.ModuleName,
		// todo: tax ordering
	)
